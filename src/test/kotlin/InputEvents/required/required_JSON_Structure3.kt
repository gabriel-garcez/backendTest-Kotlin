...
class InputEventJSONStructureMultipleAddressPhone {
    @Test
    fun postEvent() {
        ...
        val file =
            File("C:\\Users\\Aluga.com\\IJProjects\\EventsProject\\src\\test\\resources\\individual.create-structure-success3.json")
